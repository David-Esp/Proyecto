...
public class TestConstructivas {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("" + nearestN.toString());
          ...
          for (String result:results){
           ...
           // while( opt.getNextElement(problem)==1){}
            ...
            {
                stringI1 = new StringBuilder(); 
                stringI1.append(problem.getInstanceName()).append(" Esta MAla \n "); 
                string.append(stringI1);  
        ...
        //System.out.println("" + nearestN.toString());
          string.append(nearestN.toString()).append(" + 2 OPT").append("\n");
          for (String result:results){
            problem = new VehicleRoutingProblem("Instances/solomon_100/" +   result);
            long start = System.currentTimeMillis();  
            while ( nearestN.getNextElement(problem) == 1){}
        ...
        /**/
         ...
         //System.out.println("" + cwdt.toString()); 
          string.append(cwdt.toString()).append(" + 2OPT").append("\n");
          for (String result:results){
            problem = new VehicleRoutingProblem("Instances/solomon_100/" +   result);
            long start = System.currentTimeMillis();  
            while ( cwdt.getNextElement(problem) == 1){}
        ...
        //-------------------------------------------------
          //System.out.println("" + i1.toString());
          string.append(i1.toString()).append(" + 2OPT Heuristic ").append("\n");
          for (String result:results){
            problem = new VehicleRoutingProblem("Instances/solomon_100/" +   result);
            long start = System.currentTimeMillis();  
            while ( i1.getNextElement(problem) == 1){}
        ...
        //System.out.println("" + nearestN.toString());
          string.append(nearestN.toString()).append(" + Relocate").append("\n");
          for (String result:results){
            problem = new VehicleRoutingProblem("Instances/solomon_100/" +   result);
            long start = System.currentTimeMillis();  
            while ( nearestN.getNextElement(problem) == 1){}
        ...
        /**/
         ...
         //System.out.println("" + cwdt.toString()); 
          string.append(cwdt.toString()).append(" + Relocate ").append("\n");
          for (String result:results){
            problem = new VehicleRoutingProblem("Instances/solomon_100/" +   result);
            long start = System.currentTimeMillis();  
            while ( cwdt.getNextElement(problem) == 1){}
        ...
        //-------------------------------------------------
          //System.out.println("" + i1.toString());
          string.append(i1.toString()).append(" + Relocate Heuristic ").append("\n");
          for (String result:results){
            problem = new VehicleRoutingProblem("Instances/solomon_100/" +   result);
            long start = System.currentTimeMillis();  
            while ( i1.getNextElement(problem) == 1){}
