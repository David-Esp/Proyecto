...
public class Heuristic_CWDT extends VRPHeuristic{
        ...
        if(iterator.hasNext()){
           ...
           // double medidor = 999999999;
            ...
            if(customer.getDemand() <= availableCapacity){
                ...
                //Si es posible llegar al cliente antes de que termine su ventana de tiempo
                if((distanciaRecorrida + distancia) <= customer.getTimeWindowEnd()){
                 ...
                 //   double beginOfServiceJ;
                    ...
                    //Se suma la distancia de i a j y  el el fin de la ventana de tiempo de J
    ...
    public String toString() {
        return "Coefficient Weighted Distance Time Heuristic";
    }
